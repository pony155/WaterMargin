...
The design builds on the engine contracts for [assets](../Engine/Docs/AssetSystem.md),
[animation](../Engine/Docs/AnimationSystem.md), [world/ECS](../Engine/Docs/ECS.md),
[commands](../Engine/Docs/CommandSystem.md),
[tilemaps](../Engine/Docs/TilemapSystem.md),
[framework lifecycle](../Engine/Docs/Frameworkd.md),
[rendering](../Engine/Docs/Renderer.md), and the planned
[UI system](../Engine/Docs/UISystem.md). Game localization ownership and its
data/tooling boundary are specified in the planned
[localization system](Docs/LocalizationSystem.md). Game-specific regiment,
